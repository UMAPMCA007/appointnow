        ...
        <div class="btn-group">
            @can('business-create', App\Enums\GuardType::ADMIN)
                <a href="{{ route('admin.businessOwner.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm">
                    <i class="fas fa-plus-circle fa-sm fa-fw text-white-50"></i> @lang('messages.create') @lang('messages.business')
                </a>
            @endcan
        </div>
    </div>
                    ...
                    @foreach($businessOwners as $businessOwner)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" class="btn btn-block btn-primary @if(!$businessOwner->business()->exists()) disabledN @endif">
