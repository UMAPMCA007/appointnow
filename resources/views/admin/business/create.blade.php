...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-fw fa-building"></i> @lang('messages.create') @lang('messages.business') - {{ $businessOwner->name }}
        </h1>
    </div>
    <!-- End Page Heading -->

    <form action="{{ route('admin.business.store', $businessOwner->id) }}" method="post" autocomplete="off" id="form" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-6">
                        <a href="{{ route('admin.businessOwner.edit', $businessOwner->id) }}" class="btn btn-warning">
