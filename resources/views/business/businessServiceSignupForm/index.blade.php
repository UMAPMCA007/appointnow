...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group">
            <a href="{{ route('business.businessServiceSignupForm.create') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm">
                <i class="fas fa-plus-circle fa-sm fa-fw text-white-50"></i> @lang('messages.create') @lang('messages.signUpForm')
            </a>
        </div>
    </div>
    <!-- End Page Heading -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-block">
                                    <a href="{{ route('business.businessServiceSignupForm.edit', $serviceSignupForm->id) }}" class="btn btn-primary" title="@lang('messages.edit')">
